...
// Sat Mar 10 15:55:43 2018 by ROOT version 6.10/08
...
#ifdef zdecay_cxx
zdecay::zdecay(TTree *tree) : fChain(0) 
{
...
Int_t zdecay::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t zdecay::LoadTree(Long64_t entry)
{
...
void zdecay::Show(Long64_t entry)
{
...
Int_t zdecay::Cut(Long64_t entry)
{
